...
-asn1_info([{vsn,'5.0.21'},
            {module,'PKCS-FRAME'},
            {options,[{i,"/build/erlang-FHD3tY/erlang-25.1.2+dfsg/lib/public_key/asn1/../src"},
 warnings,ber,errors,
 {cwd,"/build/erlang-FHD3tY/erlang-25.1.2+dfsg/lib/public_key/asn1"},
 {outdir,"/build/erlang-FHD3tY/erlang-25.1.2+dfsg/lib/public_key/asn1/../src"},
 der,noobj,asn1config,
 {i,"."},
 {i,"/build/erlang-FHD3tY/erlang-25.1.2+dfsg/lib/public_key/asn1"}]}]).
