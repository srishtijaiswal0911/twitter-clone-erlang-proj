...
server(Username_Profile_Mapping, Hashtag_Mapping, Mentions_Mapping) ->
    ...
    receive
        ...
        {subscribe, Username1, Username2, User_Id} ->
            ...
            server(Username_Profile_Mapping, Hashtag_Mapping, Mentions_Mapping);
        {search_subscribe, Username1, Username2, User_Id} ->
            Profile_1 = maps:get(Username1, Username_Profile_Mapping),
            Profile_2 = maps:get(Username2, Username_Profile_Mapping),
            ...
            server(Username_Profile_Mapping, Hashtag_Mapping, Mentions_Mapping);
        {search_hashtag, Username, Hashtag, User_Id} ->
            Profile = maps:get(Username, Username_Profile_Mapping),
            Pid = maps:get("id", Profile),
            B = maps:is_key(Hashtag, Hashtag_Mapping),
            if B ->
                   Pid ! {search_hashtag, Hashtag, maps:get(Hashtag, Hashtag_Mapping), User_Id};
               true ->
                   Pid ! {search_hashtag, Hashtag, [], User_Id}
            end,
            server(Username_Profile_Mapping, Hashtag_Mapping, Mentions_Mapping);
        {search_mention, Username, Mention, User_Id} ->
            Profile = maps:get(Username, Username_Profile_Mapping),
            Pid = maps:get("id", Profile),
            B = maps:is_key(Mention, Mentions_Mapping),
            if B ->
                   Pid ! {search_mention, Mention, maps:get(Mention, Mentions_Mapping), User_Id};
               true ->
                   io:fwrite(Fd, "User could not be found ~n"),
                   Pid ! {search_mention, Mention, [], User_Id}
            end,
            server(Username_Profile_Mapping, Hashtag_Mapping, Mentions_Mapping);
        {add_tweet_feed, Username, Tweet} ->
        ...
        {retweet, Username, Tweet, User_Id} ->
            ...
            if A == true ->
               ...
               true ->
                   io:fwrite(Fd, "Tweet could not be found ~n"),
                   ok
            end,
            server(Username_Profile_Mapping, Hashtag_Mapping, Mentions_Mapping);
